 ...
 * 
 */
@WebServiceClient(name = "GeoIPService", targetNamespace = "http://www.webservicex.net/", wsdlLocation = "file:/Users/Sale/wsdl/geoipservice.asmx.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/Users/Sale/wsdl/geoipservice.asmx.wsdl");
